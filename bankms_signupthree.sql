...
CREATE TABLE `signupthree` (
  ...
  `Atm_ser` varchar(20) DEFAULT NULL,
  `Email_ser` varchar(20) DEFAULT NULL,
  `Cheque_Ser` varchar(20) DEFAULT NULL,
  `estatement_ser` varchar(20) DEFAULT NULL,
...
INSERT INTO `signupthree` VALUES (' 7027','2558','Savings','1','0','0','0','1'),('2281','1343','fixed Deposit','1','0','0','0','1'),('6874','3941','Current','0','1','0','0','1');
